...
<form action="./index.php" method="get" class="form-horizontal table-search" role="form">
        ...
        <input type="hidden" name="r" value="videos.list.<?php  echo $st;?>" />
            ...
            <tbody>
                ...
                <tr rel="pop" data-title="ID: <?php  echo $row['id'];?> ">
                    ...
                    <td> 
						...
						<label class='label <?php  if($st == 'status0') { ?><?php  } else if($st == 'status2') { ?><?php  } else if($st == 'status3') { ?>label-danger<?php  } else if($st == 'status1') { ?>label-success<?php  } else if($st == 'isshow0') { ?>label-warning<?php  } else if($st == 'isshow1') { ?>label-primary<?php  } ?>'>
						<?php  if($st == 'status0') { ?>待审核
						<?php  } else if($st == 'status2') { ?>未通过
						<?php  } else if($st == 'status1') { ?>已通过
                    ...
                    <td  style="overflow:visible;">
                        ...
                        <div class="btn-group btn-group-sm" >
                            ...
                            <ul class="dropdown-menu-left" role="menu" style='z-index: 9999'>
                                ...
                                <?php if(cv('videos.list.edit')) { ?>
                                    
                                    <?php  if($st == 'status0') { ?>
                                        <li>
                                        	<a class="btn btn-primary btn-xs" data-toggle="ajaxPost" href="<?php  echo webUrl('videos/list/enabled', array('id' => $row['id'],'status' => 1))?>" data-confirm="确认此视频审核通过吗？">审核通过</a>
                                        </li>
                                        ...
                                        <li>
                                        	...
                                        	<!-- <a class="btn btn-danger btn-xs" data-toggle="ajaxPost" href="<?php  echo webUrl('videos/list/enabled', array('id' => $row['id'],'status' => 2))?>" data-confirm="确认此视频审核不过吗？">审核不过</a> -->
                                        </li>
									...
									<?php  if($st == 'isshow1') { ?>
                                        <li>
											<a  class="btn btn-danger btn-xs" data-toggle="ajaxModal" href="<?php  echo webUrl('videos/goback', array('id' => $row['id'],'videoname' => $row['videoname']))?>" >退回前台重新审核
											</a>
