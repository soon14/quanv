...
<div class="navbar-collapse collapse" id="navbar">
    ...
    <ul class="nav navbar-nav gray-bg">
        ...
        <li <?php  if($_W['controller']=='app') { ?> class="active"<?php  } ?>><a href="<?php  echo webUrl('app')?>">首页</a></li>
        
        <?php if(cv('goods')) { ?>
            <li <?php  if($_W['controller']=='goods') { ?> class="active"<?php  } ?>><a href="<?php  echo webUrl('goods')?>"> 商品</a></li>
        <?php  } ?>
        <?php if(cv('consult')) { ?><li <?php  if($_W['controller']=='consult') { ?> class="active"<?php  } ?>><a href="<?php  echo webUrl('consult')?>"> 咨询</a></li><?php  } ?>
        <?php if(cv('member')) { ?>
            <li <?php  if($_W['controller']=='member') { ?> class="active"<?php  } ?>><a href="<?php  echo webUrl('member')?>"> 会员</a></li>
        <?php  } ?>
        <?php if(cv('order')) { ?>
            <li <?php  if($_W['controller']=='order') { ?> class="active"<?php  } ?>><a href="<?php  echo webUrl('order')?>"> 订单</a></li>
        <?php  } ?>
        <!-- <?php  if(p('newstore')) { ?>
            <?php if(cv('store')) { ?>
                <li <?php  if($_W['controller']=='store') { ?> class="active"<?php  } ?>><a href="<?php  echo webUrl('store/statistic')?>"> 门店</a></li>
            <?php  } ?>
        <?php  } ?> -->
        <?php if(cv('lectures')) { ?><li <?php  if($_W['controller']=='lectures') { ?> class="active"<?php  } ?>><a href="<?php  echo webUrl('lectures')?>"> 讲座</a></li><?php  } ?>
        <?php if(cv('videos')) { ?><li <?php  if($_W['controller']=='videos') { ?> class="active"<?php  } ?>><a href="<?php  echo webUrl('videos')?>"> 视频</a></li><?php  } ?>
        <?php if(cv('articles')) { ?><li <?php  if($_W['controller']=='articles') { ?> class="active"<?php  } ?>><a href="<?php  echo webUrl('articles')?>"> 文章</a></li><?php  } ?>
        <!-- <?php  if(com('sale') || com('coupon')) { ?>
            <?php if(cv('sale')) { ?>
                <li <?php  if($_W['controller']=='sale') { ?> class="active"<?php  } ?>><a href="<?php  echo webUrl('sale')?>">营销</a></li>
            <?php  } ?> 
        <?php  } ?> -->
        <?php if(cv('finance')) { ?>
            <li <?php  if($_W['controller']=='finance') { ?> class="active"<?php  } ?>><a href="<?php  echo webUrl('finance')?>"> 财务</a></li>
        <?php  } ?>
        <!-- <?php if(cv('statistics.sale')) { ?>
            <li <?php  if($_W['controller']=='statistics') { ?> class="active"<?php  } ?>><a href="<?php  echo webUrl('statistics')?>">数据</a></li>
        <?php  } ?> -->
        <?php if(cv($this->isOpenPlugin())) { ?>
            <li <?php  if($_W['controller']=='plugins' || !empty($_W['plugin'])) { ?> class="active"<?php  } ?>><a href="<?php  echo webUrl('plugins')?>">应用</a></li>
        <?php  } ?>
        <!-- <?php  if(p('diypage') && !empty($_W['shopset']['diypage']['setmenu'])) { ?>
            <li><a href="<?php  echo webUrl('diypage')?>"> 页面</a></li>
        <?php  } ?> -->
        <!-- 修改人：caifang -->
    ...
    <ul class="nav navbar-top-links navbar-right">
        <li class="dropdown">
            ...
            <ul role="menu" class="dropdown-menu">
                ...
                <li class="divider"></li>
                <?php  if(p("grant")) { ?>
                <li><a href="<?php  echo webUrl('system/plugin/pluginmanage')?>"><i class="icon icon-assessedbadge"></i> 应用授权</a></li>
                <?php  } ?>
                <li><a href="<?php  echo webUrl('system')?>"><i class="icon icon-settings"></i> 系统管理</a></li>
                <li class="divider"></li> 
	            <li><a href="<?php  echo webUrl('system/auth/upgrade')?>"><b><i class="icon icon-down"></i> 系统更新</b></a></li>
                <?php  } ?>
    ...
    <ul class="nav navbar-nav    gray-bg">
        ...
        <li <?php  if($_W['current_menu']=='auth') { ?> class="active"<?php  } ?>><a href="<?php  echo webUrl('system/auth/upgrade')?>">更新</a></li>
    </ul>
