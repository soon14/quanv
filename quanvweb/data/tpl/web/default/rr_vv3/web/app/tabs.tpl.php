...
<ul>
    <!-- <?php if(cv('app.shop.search')) { ?>
        <li <?php  if(strexists($_W['routes'], 'app.shop.search')) { ?>class="active"<?php  } ?>><a href="<?php  echo webUrl('app/shop/search')?>">搜索栏</a></li>
    <?php  } ?> -->
    <?php if(cv('app.shop.reward')) { ?>
        <li <?php  if(strexists($_W['routes'], 'app.shop.reward')) { ?>class="active"<?php  } ?>><a href="<?php  echo webUrl('app/shop/reward')?>">打赏设置</a></li>
    <?php  } ?>
    ...
    <li  <?php  if(strexists($_W['routes'], 'app.shop.notice')) { ?>class="active"<?php  } ?>><a href="<?php  echo webUrl('app/shop/notice')?>">工作站广告</a></li>
    <?php  } ?>

    <?php if(cv('app.shop.liability')) { ?>
    <li  <?php  if(strexists($_W['routes'], 'app.shop.liability')) { ?>class="active"<?php  } ?>><a href="<?php  echo webUrl('app/shop/liability')?>">免责声明</a></li>
    <?php  } ?>
