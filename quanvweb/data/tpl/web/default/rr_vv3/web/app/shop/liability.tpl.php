...
<div class="page-heading"> 
    <span class='pull-right'>
        <?php if(cv('app.shop.liability.add')) { ?>
    ...
    <div class="page-toolbar row m-b-sm m-t-sm">
        <div class="col-sm-4">
            ...
            <div class="input-group-btn">
                ...
                <?php if(cv('app.shop.liability.edit')) { ?>
                ...
                <?php  } ?>
                <?php if(cv('app.shop.liability.delete')) { ?>
    ...
    <table class="table table-responsive table-hover" >
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>     
                	<?php if(cv('app.shop.liability.edit')) { ?>
                    	<a href='javascript:;' data-toggle='ajaxEdit' data-href="<?php  echo webUrl('app/shop/liability/displayorder',array('id'=>$row['id']))?>" ><?php  echo $row['displayorder'];?></a>
                    <?php  } else { ?>
                ...
                <td>
                    ...
                    <td style="text-align:left;">
                        <?php if(cv('app.shop.liability.view|app.shop.liability.edit')) { ?>
                        	<a href="<?php  echo webUrl('app/shop/liability/edit',array('id' => $row['id']))?>" class="btn btn-default btn-sm" >
                        		<i class='fa fa-edit'></i> <?php if(cv('app.shop.liability.edit')) { ?>修改<?php  } else { ?>查看<?php  } ?>
                        	</a>
                        <?php  } ?>
                        <?php if(cv('app.shop.liability.delete')) { ?>
