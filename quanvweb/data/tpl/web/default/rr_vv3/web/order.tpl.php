    ...
    <div class="col-md-6 col-sm-6">
        <div class="ibox float-e-margins" style="border: 1px solid #e7eaec">
            <div class="ibox-title">
                ...
                <span class="pull-right">人均消费 : &yen <span class="today-avg"></span></span>
                <h5></h5>
            </div>
            <div class="ibox-content">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 text-center">
                        成交额
                        <h2 class="no-margins">&yen <span class="today-price">--</span></h2>
                    </div>
                </div>
    ...
    <div class="col-md-6 col-sm-6">
        <div class="ibox float-e-margins" style="border: 1px solid #e7eaec">
            <div class="ibox-title">
                ...
                <span class="pull-right">人均消费 : &yen <span class="yesterday-avg">--</span></span>
                <h5></h5>
            </div>
            <div class="ibox-content">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 text-center">
                        成交额
                        <h2 class="no-margins">&yen <span class="yesterday-price">--</span></h2>
                    </div>
                </div>
    ...
    <div class="col-md-6 col-sm-6">
        <div class="ibox float-e-margins" style="border: 1px solid #e7eaec">
            <div class="ibox-title">
                ...
                <span class="pull-right">人均消费 : &yen <span class="seven-avg">--</span></span>
                <h5></h5>
            </div>
            <div class="ibox-content">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 text-center">
                        成交额
                        <h2 class="no-margins">&yen <span class="seven-price">--</span></h2>
                    </div>
                </div>
    ...
    <div class="col-md-6 col-sm-6">
        <div class="ibox float-e-margins" style="border: 1px solid #e7eaec">
            <div class="ibox-title">
                ...
                <span class="pull-right">人均消费 : &yen <span class="month-avg">--</span></span>
                <h5></h5>
            </div>
            <div class="ibox-content">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 text-center">
                        成交额
                        <h2 class="no-margins">&yen <span class="month-price">--</span></h2>
                    </div>
                </div>
