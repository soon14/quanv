    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            ...
            <div class="input-group " style="margin-top:.5em;">
                <img src="<%imgsrc page.icon%>" onerror="this.src='../addons/rr_vv3/static/images/nopic.png';" class="img-responsive img-thumbnail" width="150" id="iconimg">
        ...
        <div class="inner" id="form-items">
            ...
            <div class="item" data-id="<%itemid%>">
                ...
                <div class="item-image">
                    <img src="<%imgsrc child.imgurl%>" onerror="this.src='../addons/rr_vv3/static/images/nopic.jpg';" id="pimg-<%itemid%>" />
                </div>
                <div class="item-form">
...
<script type="text/html" id="tpl_edit_notice">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            ...
            <div class="input-group " style="margin-top:.5em;">
                <img src="<%imgsrc params.iconurl%>" onerror="this.src='../addons/rr_vv3/static/images/nopic.jpg';" class="img-responsive img-thumbnail" width="150" id="iconimg">
                <span class="close" style="position:absolute; top: -10px; right: -14px;" title="重置默认图片" onclick="$('#iconsrc').val('../addons/rr_vv3/static/images/hotdot.jpg').trigger('change');$(this).prev().attr('src', '../addons/rr_vv3/static/images/hotdot.jpg')">×</span>
            </div>
        </div>
    </div>
...
<script type="text/html" id="tpl_edit_goods">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            ...
            <div class="input-group " style="margin-top:.5em;">
                <img src="<%imgsrc params.goodsiconsrc%>" onerror="this.src='../addons/rr_vv3/static/images/nopic.jpg';" class="img-responsive img-thumbnail" id="goodsicon" style="width: 60px; height: 60px;">
        ...
        <div class="inner" id="form-items">
            ...
            <div class="item" data-id="<%itemid%>">
                ...
                <div class="item-image square">
                    ...
                    <img src="<%imgsrc child.thumb%>" onerror="this.src='../addons/rr_vv3/static/images/nopic.jpg';" id="pimg-<%itemid%>" />
                    <input type="hidden" class="diy-bind" data-bind-parent="data" data-bind-child="<%itemid%>" data-bind="imgurl"  id="cimg-<%itemid%>" value="<%child.imgurl%>" />
                </div>
                <div class="item-form">
                    <div class="input-group" style="margin-bottom:0px; ">
...
<script type="text/html" id="tpl_edit_seckillgroup">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            ...
            <div class="input-group " style="margin-top:.5em;">
                <img src="<%imgsrc params.iconurl%>" onerror="this.src='../addons/rr_vv3/static/images/nopic.jpg';" class="img-responsive img-thumbnail" id="iconimg" style="height: 30px; width: 90px;">
                <span class="close" style="position:absolute; top: -10px; right: -14px;" title="删除图片" onclick="$('#iconsrc').val('').trigger('change');$(this).prev().attr('src', '../addons/rr_vv3/static/images/hotdot.jpg')">×</span>
            </div>
        ...
        <div class="inner" id="form-items">
            ...
            <div class="item" data-id="<%itemid%>">
                ...
                <div class="item-image" style="height: 110px;">
                    <img src="<%imgsrc child.imgurl%>" onerror="this.src='../addons/rr_vv3/static/images/nopic.jpg';" id="pimg-<%itemid%>" style="height: 100%; width: auto;" />
                </div>
                <div class="item-form">
                    <div class="input-group" style="margin-bottom:0px; ">
                    ...
                    <div class="input-group " style="margin-top:10px; margin-bottom:0px; ">
                        ...
                        <span class="form-control input-sm" style="padding-top: 0;">
                            <label class="radio-inline" style="padding-top: 4px;">
                                <input type="radio" name="couponcolor-<%itemid%>" value="#55b5ff" class="diy-bind" data-bind-parent="data" data-bind-child="<%itemid%>" data-bind="couponcolor" style="margin-top: 4px;" <%if child.couponcolor=='#55b5ff'||!child.couponcolor%>checked<%/if%>> 蓝</label>
                            <label class="radio-inline" style="padding-top: 4px;">
                                <input type="radio" name="couponcolor-<%itemid%>" value="#ff5555" class="diy-bind" data-bind-parent="data" data-bind-child="<%itemid%>" data-bind="couponcolor" style="margin-top: 4px;" <%if child.couponcolor=='#ff5555'%>checked<%/if%>> 红</label>
                            <label class="radio-inline" style="padding-top: 4px;">
                                <input type="radio" name="couponcolor-<%itemid%>" value="#ff913f" class="diy-bind" data-bind-parent="data" data-bind-child="<%itemid%>" data-bind="couponcolor" style="margin-top: 4px;" <%if child.couponcolor=='#ff913f'%>checked<%/if%>> 橙</label>
                            <label class="radio-inline" style="padding-top: 4px;">
                                <input type="radio" name="couponcolor-<%itemid%>" value="#fd72d4" class="diy-bind" data-bind-parent="data" data-bind-child="<%itemid%>" data-bind="couponcolor" style="margin-top: 4px;" <%if child.couponcolor=='#fd72d4'%>checked<%/if%>> 粉</label>
                        </span>
                        <!--
...
<script type="text/html" id="tpl_edit_fixedsearch">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            ...
            <div class="input-group " style="margin-top:.5em;">
                <img src="<%imgsrc params.leftnavimg%>" onerror="this.src='../addons/rr_vv3/static/images/nopic.jpg';" class="img-responsive img-thumbnail" style="height: 50px; background: #eee;" id="showleftnavimg">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            ...
            <div class="input-group " style="margin-top:.5em;">
                <img src="<%imgsrc params.rightnavimg%>" onerror="this.src='../addons/rr_vv3/static/images/nopic.jpg';" class="img-responsive img-thumbnail" style="height: 50px; background: #eee;" id="showrightnavimg">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <div class="input-group input-group-sm">
                ...
                <span class="input-group-addon btn" style="border-left: 0;" onclick="$('#moneyicon').val('../addons/rr_vv3/plugin/diypage/static/images/default/icon_money.png').trigger('change');">恢复默认</span>
            </div>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <div class="input-group input-group-sm">
                ...
                <span class="input-group-addon btn" style="border-left: 0;" onclick="$('#crediticon').val('../addons/rr_vv3/plugin/diypage/static/images/default/icon_credit.png').trigger('change')">恢复默认</span>
            </div>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <div class="input-group input-group-sm">
                ...
                <span class="input-group-addon btn" style="border-left: 0;" onclick="$('#couponicon').val('../addons/rr_vv3/plugin/diypage/static/images/default/icon_coupon.png').trigger('change')">恢复默认</span>
            </div>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <div class="input-group input-group-sm">
                ...
                <span class="input-group-addon btn" style="border-left: 0;" onclick="$('#redbagicon').val('../addons/rr_vv3/plugin/diypage/static/images/default/icon_redbag.png').trigger('change')">恢复默认</span>
            </div>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <div class="input-group input-group-sm">
                ...
                <span class="input-group-addon btn" style="border-left: 0;" onclick="$('#goodsicon').val('../addons/rr_vv3/plugin/diypage/static/images/default/icon_goods.png').trigger('change')">恢复默认</span>
            </div>
