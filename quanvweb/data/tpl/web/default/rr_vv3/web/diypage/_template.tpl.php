<?php defined('IN_IA') or exit('Access Denied');?><script type="text/html" id="tpl_show_notice">
    <div class="drag" data-itemid="<%itemid%>">
        <div class="fui-notice" style="background: <%style.background%>">
            <div class="image"><img src="<%imgsrc params.iconurl%>" onerror="this.src='../addons/rr_vv3/static/images/hotdot.jpg'"></div>
...
<script type="text/html" id="tpl_show_richtext">
    <div class="drag" data-itemid="<%itemid%>">
        <div class="diy-richtext" style="background: <%style.background%>; padding: <%style.padding%>px;">
            ...
            <p>也可在这里插入图片</p>
            <p><img src="../addons/rr_vv3/plugin/diypage/static/images/default/sale-by.png"></p>
...
<script type="text/html" id="tpl_show_goods">
    <div class="drag" data-itemid="<%itemid%>">
        <div class="fui-goods-group <%style.liststyle%>" style="background: <%style.background%>;">
            ...
            <div class="fui-goods-item" data-goodsid="<%item.gid%>">
                <div class="image <%if params.showicon=='1'%><%style.iconstyle%><%/if%>" style="background-image: url('<%imgsrc item.thumb%>');"
                    ...
                    >
                    <%if params.showicon=='1'%>
                    <img src="../addons/rr_vv3/plugin/diypage/static/images/default/goodsicon-<%style.goodsicon%>.png" style="width: <%style.iconzoom||'100'%>%;" />
                    <%/if%>
            ...
            <%if params.saleout==1%><div class="salez diy" style="background-image: url('../addons/rr_vv3/plugin/diypage/static/images/default/saleout-<%style.saleoutstyle%>.png'); "></div><%/if%>
            <%/if%>
        </div>
        <%/each%>
        <%/if%>
        ...
        <div class="fui-goods-item">
            <div class="image <%if params.showicon=='1'%><%style.iconstyle%><%/if%>" style="background-image: url('../addons/rr_vv3/plugin/diypage/static/images/default/goods-1.jpg');"
                 data-text="
                                <%if params.showicon=='1'%>
                                        <%if style.goodsicon=='recommand'%>推荐<%/if%>
                                        <%if style.goodsicon=='hotsale'%>热销<%/if%>
    ...
    <div class="drag" data-itemid="<%itemid%>">
        ...
        <div class="headinfo" style="background: <%style.background%>; <%if style.background%>border: none;<%/if%>">
            ...
            <div class="child userinfo" style="color: <%style.textcolor%>;">
                <div class="face <%style.headstyle%>"><img src="../addons/rr_vv3/static/images/nopic100.jpg"></div>
    ...
    <div class="drag" data-itemid="<%itemid%>">
        ...
        <div class="headinfo commission" style="background-color: <%style.background%>;">
            <div class="userinfo" style="border-bottom: 1px solid <%style.textcolor%>;">
                <div class="fui-list">
                    <div class="fui-list-media"><img src="../addons/rr_vv3/static/images/nopic100.jpg"></div>
...
<script type="text/html" id="tpl_show_detail_swipe">
    <div class="drag" data-itemid="<%itemid%>">
        <div class="diy-swipe">
            <img src="../addons/rr_vv3/plugin/diypage/static/template/detail1/goods.jpg">
            <div class="dots <%style.dotalign||'left'%> <%style.dotstyle||'rectangle'%>" style="padding: 0 <%style.leftright||'10'%>px; bottom: <%style.bottom||'10'%>px; opacity: <%style.opacity||'0.8'%>;">
                <span style="background: <%style.background||'#000000'%>;"></span>
                <span style="background: <%style.background||'#000000'%>;"></span>
                <span style="background: <%style.background||'#000000'%>;"></span>
        ...
        <div class="fui-cell-group fui-cell-click  fui-sale-group" style="background: <%style.background%>; margin-top: <%style.margintop%>px; margin-bottom: <%style.marginbottom%>px;">
            ...
            <div class="fui-cell">
                <div class="fui-cell-text" style="color: <%style.textcolor%>;">
                    ...
                    <span class="coupon-mini" style="background: <%style.textcolorhigh%>;">yen50</span>
                    <span class="coupon-mini" style="background: <%style.textcolorhigh%>;">yen50</span>
                    <span class="coupon-mini" style="background: <%style.textcolorhigh%>;">yen50</span>
                </div>
                <div class="fui-cell-remark"></div>
        ...
        <div class="fui-cell-group fui-shop-group" style="background: <%style.background%>; margin-top: <%style.margintop%>px; margin-bottom: <%style.marginbottom%>px;">
            <div class="fui-list">
                <div class="fui-list-media <%params.logostyle%>">
                    <img src="<%imgsrc params.shoplogo||'../addons/rr_vv3/static/images/designer.jpg'%>">
                </div>
                ...
                <div class="fui-cell-text comment ">
                    <div class="fui-list package-list">
                        <div class="fui-list-inner package-goods" style="padding: 0;">
                            <img src="../addons/rr_vv3/plugin/diypage/static/template/detail1/goods.jpg" class="package-goods-img" alt="戴尔显示器24寸">
                            <span>粉+深蓝情侣套装</span>
                        </div>
                        <div class="fui-list-inner package-goods">
                            <img src="../addons/rr_vv3/plugin/diypage/static/template/detail1/goods.jpg" class="package-goods-img" alt="新款个性创意iphone6s手机壳磨砂苹果6情侣保护套i6日韩国简约潮">
                            <span>粉+深蓝情侣套装2</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        <div class="input-group " style="margin-top:.5em;">
                            <img src="../addons/rr_vv3/static/images/nopic.jpg" onerror="this.src='../addons/rr_vv3/static/images/nopic.jpg';" class="img-responsive img-thumbnail" width="150" id="tempimg">
        ...
        <div class="fui-list-group" style="background: <%style.background%>; margin-top: <%style.margintop%>px;">
            ...
            <div class="fui-list">
                <div class="fui-list-media">
                    <img src="<%item.thumb||'../addons/rr_vv3/plugin/diypage/static/images/default/logo.jpg'%>" class="round">
                </div>
                <div class="fui-list-inner">
            ...
            <div class="fui-list">
                <div class="fui-list-media">
                    <img src="../addons/rr_vv3/static/images/default/logo.jpg" class="round">
                </div>
                <div class="fui-list-inner">
    ...
    <div class="drag" data-itemid="<%itemid%>">
        <div class="seckill-group <%params.hideborder==1&&'noborder'%>" style="margin-top: <%style.margintop%>px; background: <%style.background%>;">
            ...
            <div class="seckill-goods">
                <div class="item">
                    <div class="thumb">
                        <img src="../addons/rr_vv3/plugin/diypage/static/images/default/iphone6.jpg" />
            ...
            <div class="swiper-container adv-container" style="">
                <div class="swiper-wrapper">
                    <div class="swiper-slide adv-slide" style="background:<%style.bgcolor%>">
                        <a ><img src="../addons/rr_vv3/plugin/diypage/static/images/default/banner-1.jpg"/></a>
                    </div>
                    <div class="swiper-slide adv-slide"  style="background:<%style.bgcolor%>">
                        <a ><img src="../addons/rr_vv3/plugin/diypage/static/images/default/banner-2.jpg"/></a>
                    </div>
                    <div class="swiper-slide adv-slide"  style="background:<%style.bgcolor%>">
                        <a ><img src="../addons/rr_vv3/plugin/diypage/static/images/default/banner-1.jpg"/></a>
                    </div>
                    ...
                    <div class="swiper-slide goods-slide">
                        <div class="fui-list-group">
                            ...
                            <div class='fui-list align-start' style="background:<%style.bgcolor%>">
                                <div class='fui-list-media'>
                                    <img src="../addons/rr_vv3/plugin/diypage/static/images/default/goods-1.jpg" />
                                </div>
                                <div class='fui-list-inner'>
                            ...
                            <div class='fui-list align-start' style="background:<%style.bgcolor%>">
                                <div class='fui-list-media'>
                                    <img src="../addons/rr_vv3/plugin/diypage/static/images/default/goods-2.jpg" />
                                </div>
                                <div class='fui-list-inner'>
                            ...
                            <div class='fui-list align-start' style="background:<%style.bgcolor%>">
                                <div class='fui-list-media'>
                                    <img src="../addons/rr_vv3/plugin/diypage/static/images/default/goods-3.jpg" />
                                </div>
                                <div class='fui-list-inner'>
...
<script type="text/html" id="tpl_show_exchange_banner">
    <div class="drag" data-itemid="<%itemid%>">
        <div class="diy-banner">
            ...
            <img src="../addons/rr_vv3/plugin/diypage/static/images/default/banner-1.jpg" />
            <div class="dots <%style.dotalign||'left'%> <%style.dotstyle||'rectangle'%>" style="padding: 0 <%style.leftright||'10'%>px; bottom: <%style.bottom||'10'%>px; opacity: <%style.opacity||'0.8'%>;">
                <span style="background: <%style.background||'#000000'%>;"></span>
                <span style="background: <%style.background||'#000000'%>;"></span>
            </div>
...
<script type="text/html" id="tpl_show_exchange_input">
    <div class="drag nodelete" data-itemid="<%itemid%>">
        <div class="diy-exchange-input">
            ...
            <div class="list">
                <div class="item">
                    <div class="ico money" style="background-image: url(<%imgsrc params.moneyicon||'../addons/rr_vv3/plugin/diypage/static/images/default/icon_money.png'%>)"></div>
                    <div class="info">
                ...
                <div class="item">
                    <div class="ico credit" style="background-image: url(<%imgsrc params.crediticon||'../addons/rr_vv3/plugin/diypage/static/images/default/icon_credit.png'%>)"></div>
                    <div class="info">
                ...
                <div class="item">
                    <div class="ico coupon" style="background-image: url(<%imgsrc params.couponicon||'../addons/rr_vv3/plugin/diypage/static/images/default/icon_coupon.png'%>)"></div>
                    <div class="info">
                ...
                <div class="item">
                    <div class="ico redbag" style="background-image: url(<%imgsrc params.redbagicon||'../addons/rr_vv3/plugin/diypage/static/images/default/icon_redbag.png'%>)"></div>
                    <div class="info">
                ...
                <div class="item">
                    <div class="ico redbag" style="background-image: url(<%imgsrc params.goodsicon||'../addons/rr_vv3/plugin/diypage/static/images/default/icon_goods.png'%>)"></div>
                    <div class="info">
            ...
            <ul class="banner-ul">
                <li class="">
                    <a>
                        ...
                        <img src="../addons/rr_vv3/plugin/diypage/static/images/default/goods-1.jpg" alt=""><p>测试核销商品</p>
                    </a>
                </li>
                <li class="banner-li-blue">
                    <a>
                        <div></div><span>待使用</span>
                        <img src="../addons/rr_vv3/plugin/diypage/static/images/default/goods-2.jpg" alt=""><p>测试核销商品</p>
                    </a>
                </li>
            </ul>
            <%else%>
