...
<div class="form-group">
    ...
    <div class="col-sm-9 col-xs-12">
        ...
        <div class='form-control-static'>
            ...
            <?php  } else { ?>
            <?php  echo pdo_fetchcolumn('select levelname from '.tablename('rr_v_member_level').' where id=:id limit 1',array(':id'=>$member['level']))?>
            <?php  } ?>
        </div>
        <?php  } ?>
    </div>
...
<div class="form-group">
    ...
    <div class="col-sm-9 col-xs-12">
        ...
        <div class='form-control-static'>
            ...
            无分组
            <?php  } else { ?>
            <?php  echo pdo_fetchcolumn('select groupname from '.tablename('rr_v_member_group').' where id=:id limit 1',array(':id'=>$member['groupid']))?>
            <?php  } ?>
        </div>
        <?php  } ?>
    </div>
...
<?php  if(strexists($member['openid'],'sns_wa_')) { ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9 col-xs-12">
            ...
            <?php  if($member['identity']==0 && $member['isaudit']==0) { ?>

                <?php if(cv('member.list.edit')) { ?>

                <label class="radio-inline"><input type="radio" name="data[identity]" value="0" <?php  if($member['identity']==0) { ?>checked<?php  } ?>>患者</label>

                <label class="radio-inline" ><input type="radio" name="data[identity]" value="1" <?php  if($member['identity']==1) { ?>checked<?php  } ?>>医生</label>
                <?php  } ?>
            ...
            <div class='form-control-static'>
                ...
                <label class="label <?php  if($member['isaudit']==1) { ?>label-danger<?php  } else if($member['identity']==1) { ?>label-primary<?php  } else { ?>label-success<?php  } ?>">
                    <?php  if($member['isaudit']==1) { ?>待审核<?php  } else if($member['isaudit']==3) { ?>审核不过<?php  } else if($member['identity']==1) { ?>医生<?php  } else { ?>患者<?php  } ?>
                </label>
