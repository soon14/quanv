...
<div class="wrapper">
	...
	<div class="card_empty" <?php  if(!empty($card)) { ?> style="display: none" <?php  } ?>>
        <img src="../addons/rr_vv3/static/images/card_empty.jpg" alt="" />
        <p>暂无微信会员卡</p>
		<?php if(cv('member.card.add')) { ?>
	...
	<div class="basic" <?php  if(empty($card)) { ?> style="display: none" <?php  } ?>>
		...
		<div class="basic_content">
			...
			<div class="card_cell">
				...
				<?php if(cv('member.card.stock')) { ?>
				<a data-toggle="ajaxModal" href="<?php  echo webUrl('member/card/stock', array('id'=>$row['id'],'card_id'=>$row['card_id']))?>" title='修改库存'><img style="position: absolute;right: -30px;top: 28px;" src="../addons/rr_vv3/static/images/edit_img.jpg" alt="" /></a>
				<?php  } ?>
