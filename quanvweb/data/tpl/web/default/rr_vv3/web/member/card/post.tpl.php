...
<link rel="stylesheet" type="text/css" href="../addons/rr_vv3/static/css/card/index.css"/>
...
<link rel="stylesheet" type="text/css" href="../addons/rr_vv3/template/web/sale/wxcard/css/iconfont.css"/>
...
<div class="wrapper">
    ...
    <div class="preview" style="overflow: visible;position: relative;margin-top: 30px;top: 0;">
        <div class="cart-top">
            <img src="../addons/rr_vv3/static/images/cart_top.jpg" alt=""/>
        </div>
        <div class="title">
        ...
        <div class="panel">
            ...
            <div class="logo-area">
                ...
                <div class="logo">
                    <img id="logoimg" src="<?php  if(empty($card)) { ?>../addons/rr_vv3/static/images/default.png<?php  } else { ?><?php  echo $card['card_logoimg'];?><?php  } ?>"/>
                </div>
                ...
                <div class="code">
                    <img src="../addons/rr_vv3/static/images/code.jpg" alt="" />
                </div>
    ...
    <!--控制台-->
        <div class="control" style="padding: 10px;margin-top: 30px;border: 1px solid #d0d1d2;width: 582px;">
            <div class="editor_section">
                ...
                <div class="control-group limit">
                    ...
                    <div class="frm_controls">
                        ...
                        <input type="text" name="card_brand_name" id="card_brand_name" class="input" value="<?php  echo $card['card_brand_name'];?>" <?php  if(!empty($card)) { ?>disabled<?php  } ?> maxlength=15/>
                        <?php  } else { ?>
                ...
                <div class="control-group limit">
                    ...
                    <div class="frm_controls">
                        <?php if(cv('member.card')) { ?>
                        <input type="text" name="card_title" id="card_title" class="input" value="<?php  echo $card['card_title'];?>" <?php  if(!empty($card)) { ?>disabled<?php  } ?> maxlength=15 />
                        <?php  } else { ?>
                ...
                <hr style="height: 3px; background: #fff;margin: 0 -30px">
                ...
                <div class="control-group limit">
                    ...
                    <div class="frm_controls">
                        <?php if(cv('member.card')) { ?>
                        <input type="text" name="card_totalquantity" id="card_totalquantity" maxlength=10  class="input" value="<?php  echo $card['card_totalquantity'];?>" <?php  if(!empty($card)) { ?>disabled<?php  } ?> />
                        <?php  } else { ?>
                ...
                <div class="control-group">
                    ...
                    <div class="frm_controls">
                        <div class="frm-image">
                            ...
                            <img  id="showlogo" style="border-radius: 50%" src="<?php  if(empty($card)) { ?>../addons/rr_vv3/static/images/default.png<?php  } else { ?><?php  echo $card['card_logoimg'];?><?php  } ?>" />
                        </div>
                    </div>
                    <div class="frm_controls">
                ...
                <div class="control-group">
                    ...
                    <?php  } ?>
                    <div class="frm_controls">
                        <p class='frm_tip'>使用微信卡券余额（具体为在会员卡中使用“余额/supply_balance”字段）需提交《单用途预付卡备案》。 操作指引详见： <a href="https://mp.weixin.qq.com/cgi-bin/readtemplate?token=1091016770&t=cardticket/faq_tmpl&type=info&token=1494071418&lang=zh_CN#3dot2">卡券储值功能权限开通</a>。</p>
                    </div>
                    ...
                    <?php if(cv('member.card')) { ?>
                        <div class="frm_controls">
                            <input type="radio" name="card_backgroundtype" value="0"
                                   ...
                                   <?php  if(empty($card['card_backgroundtype'])) { ?>checked="true"<?php  } ?> />
                            <span>使用背景色</span>
                        </div>
                        <div class="frm_controls">
                ...
                <!--会员卡背景图-->
                <div class="control-group backgroundimg" <?php  if(empty($card['card_backgroundtype'])) { ?> style="display:none;"<?php  } ?>>
                    <div class="frm_label pull-left">
                        会员卡背景图
                    </div>
                    <div class="frm_controls">
                        <div class="frm-image">
                            ...
                            <img  id="showbackground"  src="<?php  echo $card['card_backgroundimg'];?>"/>
                        </div>
                    </div>
                    <div class="frm_controls">
                ...
                <div class="control-group">
                    ...
                    <div class="input-group">
                        <textarea  name="prerogative" rows="5" cols="50"><?php  echo $card['prerogative'];?></textarea>
                    </div>
                    <?php  } else { ?>
                ...
                <div class="control-group">
                    ...
                    <?php if(cv('member.card')) { ?>
                    <div class="input-group">
                        <textarea  name="card_description" rows="5" cols="50"><?php  echo $card['card_description'];?></textarea>
                    </div>
                    <?php  } else { ?>
                ...
                <div class="control-group">
                    ...
                    <div class="frm_controls">
                        ...
                        <div class="con-label">
                            ...
                            <input type="checkbox" name="withpet" id="withpet" <?php  if(!empty($card['withpet'])) { ?>checked<?php  } ?> <?php  if(!empty($card)) { ?>disabled<?php  } ?> />可带宠物</div>
                        <div class="con-label">
                            <!--BIZ_SERVICE_FREE_PARK-->
                            <input type="checkbox" name="freepark" id="freepark" <?php  if(!empty($card['freepark'])) { ?>checked<?php  } ?> <?php  if(!empty($card)) { ?>disabled<?php  } ?> / >免费停车</div>
                        <div class="con-label">
                            <!--BIZ_SERVICE_DELIVER-->
                            <input type="checkbox" name="deliver" id="deliver" <?php  if(!empty($card['deliver'])) { ?>checked<?php  } ?> <?php  if(!empty($card)) { ?>disabled<?php  } ?> / >可外卖</div>
                    </div>
                    <p class='card_tip'>会员卡商户服务创建后无法修改</p>
                    <?php  } else { ?>
                    <div class='frm_controls'>
                ...
                <div class="control-group">
                    ...
                    <?php if(cv('member.card')) { ?>
                    <div class="frm_controls">
                        <input type="radio" name="custom_cell1" value="0"   onclick="$('.custom_cell1').hide();$('#show_custom_cell1').hide();" <?php  if(empty($card['custom_cell1'])) { ?>checked="true"<?php  } ?> />
                        <span>关闭</span>
                    </div>
                    <div class="frm_controls">
                        <input type="radio" name="custom_cell1" value="1"  onclick="$('.custom_cell1').show();$('#show_custom_cell1').show();" <?php  if(!empty($card['custom_cell1'])) { ?>checked="true"<?php  } ?>  />
                        <span>开启</span>
                    </div>
                    <?php  } else { ?>
                ...
                <!--入口名称-->
                <div class="control-group custom_cell1"  <?php  if(empty($card['custom_cell1'])) { ?> style="display:none;"<?php  } ?>>
                    <div class="frm_label pull-left">
                        入口名称
                    </div>
                    <div class="frm_controls">
                        <?php if(cv('member.card')) { ?>
                        <input type="text" name="custom_cell1_name" id="custom_cell1_name" class="input" value="<?php  echo $card['custom_cell1_name'];?>" />
                        <?php  } else { ?>
                ...
                <div class="control-group custom_cell1"  <?php  if(empty($card['custom_cell1'])) { ?> style="display:none;"<?php  } ?>>
                    ...
                    <div class="frm_controls">
                        <?php if(cv('member.card')) { ?>
                        <input type="text" name="custom_cell1_tips" id="custom_cell1_tips" class="input" value="<?php  echo $card['custom_cell1_tips'];?>" />
                        <?php  } else { ?>
                ...
                <div class="control-group custom_cell1"  <?php  if(empty($card['custom_cell1'])) { ?> style="display:none;"<?php  } ?>>
                    ...
                    <div class="frm_controls">
                        <?php if(cv('member.card')) { ?>
                        <input type="text" name="custom_cell1_url" id="custom_cell1_url" class="input" value="<?php  echo $card['custom_cell1_url'];?>"  />
...
<div class='panel-body' style="text-align: right;">
    ...
    <?php if(cv('member.card.add|member.card.edit')) { ?>
...
<script type="text/javascript" src="../addons/rr_vv3/static/js/app/biz/sale/wxcard/colorpalette.js" charset="utf-8"></script>
