...
"><i class='fa fa-question-circle'></i></a></td>
                    ...
                    <table class='ordertable' style='table-layout:fixed;border-top:1px dotted #ccc'>
                        ...
                        <?php  if($item['isverify']==1) { ?>
                            <?php  if(!empty($item['verifyendtime'])) { ?>
                            <tr>
                            ...
                            <?php  if($item['verifytype']==0 && $item['status']>=1) { ?>
                                <tr>
            ...
            <div class='panel-body' >
                <div class='row'>
                    ...
                    <div class="col-sm-9 col-xs-12">
                        ...
                        <?php  if($item['status'] == -1 && (!empty($item['closereason']) || !empty($item['remarkclose']))) { ?>
                        <div class="form-control-static">关闭原因:<?php  if(!empty($item['closereason'])) { ?><?php  echo $item['closereason']?><?php  } else { ?><?php  echo $item['remarkclose']?><?php  } ?></div>
                        <?php  } ?>
                    </div>
                </div>
            ...
            <table class="table table-hover">
                ...
                <tr>
                    <td class='full'>
                        ...
                        <?php  } ?>
                        <?php  if($goods['goodstype'] == '1') { ?><a target="_blank" title="查看"><?php  echo $goods['title'];?></a>
                        <?php  } else if($goods['goodstype'] == '2') { ?><a target="_blank" title="查看"><?php  echo $goods['title'];?></a>
                        <?php  } else if($goods['goodstype'] == '3') { ?><a target="_blank" title="查看"><?php  echo $goods['title'];?></a>
                        <?php  } else if($goods['goodstype'] == '4') { ?><a target="_blank" title="查看"><?php  echo $goods['title'];?></a>
                        <?php  } else if($goods['goodstype'] == '5') { ?><a target="_blank" title="查看"><?php  echo $goods['title'];?></a>
                        <?php  } else { ?>
