...
<form action="./index.php" method="get" class="form-horizontal table-search" role="form">
        ...
        <input type="hidden" name="r" value="consult.historys" />
        ...
        <div class="page-toolbar row m-b-sm m-t-sm">
            ...
            <div class="col-sm-4">
                ...
                <div class="input-group-btn">
                  ...
                  <?php if(cv('consult.historys.delete')) { ?>

                    <!-- <button class="btn btn-default btn-sm" type="button" data-toggle='batch-remove' data-confirm="确认要删除?" data-href="<?php  echo webUrl('consult/historys/delete')?>"><i class='fa fa-trash'></i> 批量删除</button> -->
