...
<form action="./index.php" method="get" class="form-horizontal table-search" role="form">
        ...
        <input type="hidden" name="r" value="consult.finishs" />
        ...
        <div class="page-toolbar row m-b-sm m-t-sm">
            ...
            <div class="col-sm-4">
                ...
                <div class="input-group-btn">
                  ...
                  <?php if(cv('consult.finishs.delete')) { ?>

                    <!-- <button class="btn btn-default btn-sm" type="button" data-toggle='batch-remove' data-confirm="确认要删除?" data-href="<?php  echo webUrl('consult/finishs/delete')?>"><i class='fa fa-trash'></i> 批量删除</button> -->
                    ...
                    <td  style="overflow:visible;">
                        ...
                        <div class="btn-group btn-group-sm" >
                            ...
                            <ul class="dropdown-menu-left" role="menu" style='z-index: 9999'>
                                ...
                                <?php if(cv('consult.finishs.finishdetail')) { ?>

                                    <li><a href="<?php  echo webUrl('consult/finishs/finishdetail',array('id' => $row['id']));?>" title="查看详情"><i class='fa fa-edit'></i> 查看详情</a></li>
