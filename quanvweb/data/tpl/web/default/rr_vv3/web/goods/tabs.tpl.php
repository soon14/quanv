...
<ul class='goods-list'>
   ...
   <!--  <?php  if(p('merch')) { ?>
    <li <?php  if($_GPC['goodsfrom'] == 'verify') { ?> class="active" <?php  } ?>><a href="<?php  echo webUrl('goods',array('goodsfrom'=>'verify'))?>">待审核<span  class='text-default'><?php  echo $totals['verify'];?></span></a></li>
    <?php  } ?> -->
