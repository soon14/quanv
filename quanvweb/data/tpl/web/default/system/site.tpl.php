...
<ul class="we7-page-tab">
	...
	<li class="active" style="float:right;border-bottom: 3px solid #F44336;"><a href="#" target="_blank" style="color:#F44336;">查看最新版</a></li>
</ul>
<div class="clearfix">
	<form action="" method="post"  class="we7-form" role="form" enctype="multipart/form-data" id="form1">
		...
		<div class="form-group">
			...
			<div class="col-sm-8">
				<input type="text" name="icp" value="<?php  echo $settings['icp'];?>">
			</div>
		</div>
