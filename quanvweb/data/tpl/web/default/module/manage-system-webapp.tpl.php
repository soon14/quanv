...
<ul class="we7-page-tab">
	<li <?php  if($do == 'installed') { ?>class="active"<?php  } ?>><a href="<?php  echo url('module/manage-system/installed', array('account_type' => ACCOUNT_TYPE))?>">已安装PC应用  </a></li>
	<?php  if($_W['isfounder'] && uni_user_see_more_info(ACCOUNT_MANAGE_NAME_VICE_FOUNDER, false)) { ?>
	<li <?php  if($do == 'not_installed' && $_GPC['status'] != 'recycle') { ?>class="active"<?php  } ?>><a href="<?php  echo url('module/manage-system/not_installed', array('account_type' => ACCOUNT_TYPE))?>">未安装PC应用<span class="color-red">  (<?php  echo $total_uninstalled;?>) </span></a></li>
	<li <?php  if($do == 'not_installed' && $_GPC['status'] == 'recycle') { ?>class="active"<?php  } ?>><a href="<?php  echo url('module/manage-system/not_installed', array('status' => 'recycle', 'account_type' => ACCOUNT_TYPE))?>">已停用PC应用</a></li>
	<?php  } ?>
</ul>
<?php  if($do == 'installed') { ?>
...
<div class="js-system-module-detail" ng-controller="detailCtrl" ng-cloak>
	...
	<table class="table we7-table table-hover vertical-middle">
		...
		<col width="230px" />
		<tr>
			<th colspan="3" class="text-left bg-light-gray">
				公众号列表
			</th>
		</tr>
		<tr class="hidden">
			<td class="text-left">
				<img src="" alt="" class="img-responsive icon" width="60" height="60">
			</td>
			<td class="text-left">
				<p>公众号列表</p>
				<span class="text-muted">类型： 认证服务号</span>
			</td>
			<td class="text-right">
				<div class="link-group">
					<a href="javascript:;">进入公众号</a>
				</div>
			</td>
		</tr>
		<tr>
			<td colspan="3" class="text-center">
				<span class="wi wi-warning-sign color-default" style="font-size: 24px; vertical-align: middle; margin-right: 3px;"></span>暂无公众号使用该应用模块
			</td>
		</tr>
	</table>
		...
		<div class="steps-container">
			<div>
				...
				<div class="content">
					...
					<div><a href="#" class="color-default">去添加应用组 ></a></div>
				</div>
			</div>
			<div>
				<div class="num">2</div>
				...
				<div class="content">
					...
					<div><a href="#" class="color-default">去添加用户权限组 ></a></div>
				</div>
			</div>
			<div>
				<div class="num">3</div>
				...
				<div class="content">
					...
					<div><a href="#" class="color-default">去分配用户组 ></a></div>
				</div>
			</div>
		</div>
	</div>
