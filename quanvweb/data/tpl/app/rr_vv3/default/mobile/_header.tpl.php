...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="../addons/rr_vv3/static/js/dist/foxui/css/foxui.min.css?v=0.2">
        <link rel="stylesheet" type="text/css" href="../addons/rr_vv3/template/mobile/default/static/css/style.css?v=2.0.9">
        <?php  if(is_h5app()) { ?>
        <link rel="stylesheet" type="text/css" href="../addons/rr_vv3/template/mobile/default/static/css/h5app.css?v=2.0.3">
        <?php  } ?>

        <link rel="stylesheet" type="text/css" href="<?php  echo rr_vv3_LOCAL?>static/fonts/iconfont.css?v=2017070719">
...
<!--   <script src="../addons/rr_vv3/static/js/dist/foxui/js/foxui.min.js"></script>-->
        <script src="<?php  echo rr_vv3_LOCAL?>static/js/require.js"></script>
        <script src="<?php  echo rr_vv3_LOCAL?>static/js/myconfig-app.js"></script>
