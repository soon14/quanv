...
<div class='fui-page  fui-page-current'>
			...
			<div class="headinfo" style="z-index:100;border: none;">
				...
				<div class="child userinfo">
					<a href="<?php  echo mobileUrl('member/info/face')?>" data-nocache="true" style="color: white;">
						<div class="face"><img src="<?php  echo $member['avatar'];?>" onerror="this.src='../addons/rr_vv3/static/images/noface.png'"/></div>
	...
	<?php  if(p('task')) { ?>
	<?php  $open = pdo_get('rr_v_task_default',array('uniacid'=>$_W['uniacid']),array('open'));?>
	<?php  if($open['open']) { ?>
	<div class="fui-cell-group fui-cell-click">
		<a class="fui-cell"  href="<?php  echo mobileUrl('task')?>">
			<div class="fui-cell-icon"><i class="icon icon-hexiaoshangpin"></i></div>
