	...
	echo <<<EOF
		<div class="panel panel-default">
			...
			<div class="panel-body" style="overflow-y:scroll;max-height:400px;line-height:20px;">
				<h3>微擎1.69商业纯净版安装说明</h3>
				<p>
					读完再选择装与不装
				</p>
				<p>
					<strong>0x1 商业版只附带一个系统卡券扩展，什么200/300扩展的是个人集成的N多BUG的版本，后门无数</strong>
				</p>
				<p>
...
function tpl_install_finish() {
	...
	<div class="alert alert-danger"><i class="fa fa-exclamation-triangle"></i> 因接到多方举报，日后更新纯净版在QQ群内共享！　<a target="_blank" href="https://jq.qq.com/?_wv=1027&k=5Gznl3Z"><img border="0" src="//pub.idqqimg.com/wpa/images/group.png" alt="微信公众号运营交流群" title="微信公众号运营交流群"></a></div>
