...
class Order_RrvV3Page extends WebPage
{
	public function main()
	{
		...
		unset($row);
		$totalcount = $total = pdo_fetchall('select o.id from ' . tablename('rr_v_order') . ' o ' . ' left join ' . tablename('rr_v_member') . ' m on o.openid = m.openid ' . ' left join ' . tablename('rr_v_member_address') . ' a on a.id = o.addressid ' . ' where 1 ' . $condition, $params);
