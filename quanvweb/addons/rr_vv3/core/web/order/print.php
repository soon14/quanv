...
class Print_RrvV3Page extends WebPage 
{
	...
	public function shengchan(){
		...
		$stores[$key] = pdo_fetchall('select * from ' . tablename('rr_v_order') . ' where uniacid=:uniacid and id=:orderid', array(':uniacid' => $uniacid,':orderid' => $orderId));		
