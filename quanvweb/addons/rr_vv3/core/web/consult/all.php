...
class All_RrvV3Page extends WebPage
{
	public function main()
	{
		...
		$condition = ' uniacid=:uniacid and isdelete=0';
		...
		$sql = 'select * from ' . tablename('rr_v_consult') . ' where  ' . $condition . '  ORDER BY start_time DESC';
