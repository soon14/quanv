...
class Log_RrvV3Page extends ComWebPage
{
	...
	public function main()
	{
		...
		if (!empty($couponid)) {
			$coupon = pdo_fetch('select * from ' . tablename('rr_v_coupon') . ' where id=:id and uniacid=:uniacid and merchid=0 limit 1', array(':id' => $couponid, ':uniacid' => $_W['uniacid']));
