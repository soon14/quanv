...
class Info_RrvV3Page extends MobileLoginPage
{
	protected $member;
	...
	public function submit()
	{
		...
		if ($template_flag == 1) {
			...
			pdo_update('rr_v_member', $m_data, array('openid' => $_W['openid'], 'uniacid' => $_W['uniacid']));
	...
	public function face()
	{
		...
		if ($_W['ispost']) {
			...
			pdo_update('rr_v_member', array('avatar' => $avatar, 'nickname' => $nickname), array('id' => $member['id'], 'uniacid' => $_W['uniacid']));
			show_json(1);
		}
