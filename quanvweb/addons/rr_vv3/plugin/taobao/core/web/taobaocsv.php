...
class Taobaocsv_RrvV3Page extends PluginWebPage
{
	public function main()
	{
		...
		$uploadStart = '0';
		$uploadnum = '0';
		$excelurl = $_W['siteroot'] . 'addons/rr_vv3/plugin/taobao/data/test.xlsx';
		$zipurl = $_W['siteroot'] . 'addons/rr_vv3/plugin/taobao/data/test.zip';
