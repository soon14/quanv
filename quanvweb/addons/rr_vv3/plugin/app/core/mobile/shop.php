...
class Shop_RrvV3Page extends AppMobilePage
{
	public function get_shopindex()
	{
		...
		$notices = pdo_fetchall('select id, title, link, thumb from ' . tablename('rr_v_notice') . ' where uniacid=:uniacid' . $appsql . ' and status=1 order by displayorder desc limit 5', array(':uniacid' => $uniacid));
