...
require rr_vv3_INC . 'plugin/plugin_processor.php';
	...
	public function respond($obj = NULL)
	{
		...
		if (($msgtype == 'text') || ($event == 'click')) {
			...
			if ($obj->inContext && is_numeric($content)) {
				$log = pdo_fetch('select * from ' . tablename('rr_v_creditshop_log') . ' where eno=:eno and uniacid=:uniacid  limit 1', array(':eno' => $content, ':uniacid' => $_W['uniacid']));
