...
return array(
	...
	'menu'    => array(
		...
		'items'     => array(
			...
			array('title' => "<span class=\"text-danger update-tasknew\">升级新版</span><script>\$(function() {\r\n                        \$(\".update-tasknew\").parent(\"a\").attr(\"href\",\"javascript:;\");\r\n                        \$(\".update-tasknew\").parent(\"a\").click(function() {\r\n                            tip.confirm(\"一旦升级到新版任务中心，旧版任务中心将被覆盖，<br>未完成的任务将不能继续，确认要升级吗？\",function(){\$.ajax({url:\"./index.php?c=site&a=entry&m=rr_vv3&do=web&r=task.version\",type:\"get\",success:function() {location.href=\"\"}});})});})</script>", 'route' => 'version')
			)
		)
	);
