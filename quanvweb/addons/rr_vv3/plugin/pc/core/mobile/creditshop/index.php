...
class Index_RrvV3Page extends PcMobilePage 
{
	public function main() 
	{
		...
		$advs = pdo_fetchall('select id,advname,link,thumb from ' . tablename('rr_v_creditshop_adv') . ' where uniacid=:uniacid and enabled=1 order by displayorder desc', array(':uniacid' => $uniacid));
