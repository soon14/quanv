...
class Comment_RrvV3Page extends PluginMobileLoginPage
{
	...
	public function submit()
	{
		...
		$log = pdo_fetch('select id,status,iscomment,logno from ' . tablename('rr_v_creditshop_log') . ' where id=:id ' . $condition . ' and openid=:openid limit 1', array(':id' => $logid, ':uniacid' => $uniacid, ':openid' => $openid));
