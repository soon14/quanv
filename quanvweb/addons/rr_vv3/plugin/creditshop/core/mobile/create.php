...
class Create_RrvV3Page extends PluginMobileLoginPage
{
	...
	public function dispatch()
	{
		...
		$address = pdo_fetch('select id,realname,mobile,address,province,city,area,datavalue from ' . tablename('rr_v_member_address') . "\r\n        where id=:id and uniacid=:uniacid limit 1", array(':id' => $addressid, ':uniacid' => $_W['uniacid']));
		$user_city = '';
		$user_city_code = '';
