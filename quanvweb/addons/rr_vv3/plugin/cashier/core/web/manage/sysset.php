...
class Sysset_RrvV3Page extends CashierWebPage 
{
	...
	public function userset() 
	{
		...
		if (!(empty($item['manageopenid']))) 
		{
			...
			$manageopenid = pdo_fetchall('SELECT id,openid,avatar,nickname FROM ' . tablename('rr_v_member') . ' WHERE uniacid=:uniacid AND openid IN (' . $openids . ')', array(':uniacid' => $_W['uniacid']));
		}
		include $this->template();
	}
}
