...
class Credit_RrvV3Page extends CashierWebPage 
{
	...
	public function recharge_submit() 
	{
		...
		pdo_delete('rr_v_cashier_log', array('cashierid' => $_W['cashierid'], 'status' => 0, 'uniacid' => $_W['uniacid']));
		pdo_insert('rr_v_cashier_log', $log);
		$logid = pdo_insertid();
		if (!($logid)) 
		{
