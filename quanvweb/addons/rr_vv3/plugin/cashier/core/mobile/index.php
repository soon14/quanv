...
class Index_RrvV3Page extends CashierMobilePage 
{
	...
	public function __construct() 
	{
		global $_W;
		parent::__construct();
		$this->operatorid = (int) pdo_fetchcolumn('SELECT id FROM ' . tablename('rr_v_cashier_operator') . ' WHERE manageopenid=:manageopenid AND uniacid=:uniacid LIMIT 1', array(':manageopenid' => $_W['openid'], ':uniacid' => $_W['uniacid']));
