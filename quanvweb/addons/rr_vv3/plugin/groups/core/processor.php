...
class GroupsProcessor extends PluginProcessor
{
	public function __construct()
	{
		...
		$this->sessionkey = rr_vv3_PREFIX . 'gorder_wechat_verify_info';
		$this->codekey = rr_vv3_PREFIX . 'gorder_wechat_verify_code';
	}
