...
class Index_RrvV3Page extends PluginWebPage
{
	...
	'commission' => array('tm' => $data)
		...
		$template_list = pdo_fetchall('SELECT id,title FROM ' . tablename('rr_v_member_message_template') . ' WHERE uniacid=:uniacid and typecode=:typecode ', array(':uniacid' => $_W['uniacid'], ':typecode' => 'commission'));
