...
class Merch_RrvV3Page extends PluginWebPage 
{
	...
	public function ajax_user_data() 
	{
		...
		$merch = pdo_fetch('select * from ' . tablename('rr_v_merch_user') . ' where id = :id', array(':id' => $merchid));
