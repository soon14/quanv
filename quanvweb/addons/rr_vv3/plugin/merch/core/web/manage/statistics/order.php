...
class Order_RrvV3Page extends MerchWebPage
{
	public function main()
	{
		...
		$sql = 'select o.*, a.realname as addressname,m.realname from ' . tablename('rr_v_order') . ' o ' . ' left join ' . tablename('rr_v_member') . ' m on o.openid = m.openid ' . ' left join ' . tablename('rr_v_member_address') . ' a on a.id = o.addressid ' . ' where 1 ' . $condition . ' ';
		...
		$count = pdo_fetch('select count(o.id) as count from ' . tablename('rr_v_order') . ' o ' . ' left join ' . tablename('rr_v_member') . ' m on o.openid = m.openid ' . ' left join ' . tablename('rr_v_member_address') . ' a on a.id = o.addressid ' . ' where 1 ' . $condition, $params);
