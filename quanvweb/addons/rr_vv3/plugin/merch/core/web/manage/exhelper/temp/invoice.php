...
class Invoice_RrvV3Page extends MerchWebPage 
{
	...
	protected function post() 
	{
		...
		if ($_W['ispost']) 
		{
			...
			{
				pdo_update('rr_v_exhelper_express', array('isdefault' => 0), array('type' => 2, 'uniacid' => $_W['uniacid'], 'merchid' => $merchid));
				pdo_update('rr_v_exhelper_express', array('isdefault' => 1), array('type' => 2, 'id' => $id, 'merchid' => $merchid));
			}
