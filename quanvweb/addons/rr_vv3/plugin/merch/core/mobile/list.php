...
class List_RrvV3Page extends PluginMobilePage 
{
	public function main() 
	{
		global $_W;
		global $_GPC;
		$category = $this->model->getCategory(array( 'isrecommand' => 1, 'status' => 1, 'orderby' => array('displayorder' => 'desc', 'id' => 'asc') ));
		$merchuser = $this->model->getMerch(array( 'isrecommand' => 1, 'status' => 1, 'field' => 'id,uniacid,merchname,desc,logo,groupid,cateid', 'orderby' => array('id' => 'asc') ));
		$category_swipe = $this->model->getCategorySwipe(array( 'status' => 1, 'orderby' => array('displayorder' => 'desc', 'id' => 'asc') ));
